...
let medicalSlider = new Swiper('.slider-medical__container', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.slider-medical__arrows .slider-medical__arrow-left',
		prevEl: '.slider-medical__arrows .slider-medical__arrow-right',
	},
	/*
	breakpoints: {
		320: {
...
let sertSlider = new Swiper('.slider-sertificate__container ', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Dotts
	pagination: {
		el: '.slider-sertificate__pagination',
		clickable: true,
	},
	// Arrows
	//navigation: {
	//	nextEl: '.slider-sertificate__arrows .slider-sertificate__arrow-left',
	//	prevEl: '.slider-sertificate__arrows .slider-sertificate__arrow-right',
	//},
